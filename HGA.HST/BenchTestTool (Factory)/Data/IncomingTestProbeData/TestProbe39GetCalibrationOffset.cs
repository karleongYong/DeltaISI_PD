...
{
    public unsafe struct TestProbe39GetCalibrationOffset
    {
        ...
        public static TestProbe39GetCalibrationOffset ReadStruct(byte[] data)
        {
            fixed (byte* pb = &data[0])
            {
                return *(TestProbe39GetCalibrationOffset*)pb;
            }
        }
