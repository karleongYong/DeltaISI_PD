        ...
        private void UserChanged(object sender, EventArgs e)
        {
            try
            {
                UIUtility.Invoke(this, () =>
                {
                    ...
                    TabPage tabPageApplicationSettings = MainForm.getTabControl().TabPages[4] as TabPage;         
                    ...
                    switch (level)
                    {
                        ...
                        case UserLevel.Operator:
                            ...
                            (MainForm.getTabControl().TabPages[4] as Control).Enabled = false;   // Application Settings tab
                        ...
                        case UserLevel.Engineer:
                            ...
                            (MainForm.getTabControl().TabPages[4] as Control).Enabled = true;   // Application Settings tab                                               
