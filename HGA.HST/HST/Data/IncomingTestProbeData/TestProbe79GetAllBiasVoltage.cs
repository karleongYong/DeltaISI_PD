...
{
    public unsafe struct TestProbe79GetAllBiasVoltage
    {
        ...
        public static TestProbe79GetAllBiasVoltage ReadStruct(byte[] data)
        {
            fixed (byte* pb = &data[0])
            {
                return *(TestProbe79GetAllBiasVoltage*)pb;
            }
        }
