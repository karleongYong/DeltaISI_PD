...
{
    public unsafe struct TestProbe76GetAllSensingVoltage
    {
        ...
        public static TestProbe76GetAllSensingVoltage ReadStruct(byte[] data)
        {
            fixed (byte* pb = &data[0])
            {
                return *(TestProbe76GetAllSensingVoltage*)pb;
            }
        }
