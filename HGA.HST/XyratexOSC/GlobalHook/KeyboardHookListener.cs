...
using XyratexOSC.GlobalHook.WinApi;

namespace XyratexOSC.GlobalHook
{
    /// <summary>
    ...
    public class KeyboardHookListener : BaseHookListener
    {
        ...
        /// </summary>
        public bool NonCharPressEnabled
        {
            get;
            set;
        }
        ...
        private void InvokeKeyPress(KeyPressEventArgsExt e)
        {
            ...
            if (handler == null || e.Handled || (e.IsNonChar && !NonCharPressEnabled)) { return; }
            handler(this, e);
        }
