...
namespace MOXA
{
    ...
    /// </remarks>
    internal enum MoxaStatus
    {
        Ok = MXIO_CS.MXIO_OK,
        IllegalFunction = MXIO_CS.ILLEGAL_FUNCTION,
        IllegalDataAddress = MXIO_CS.ILLEGAL_DATA_ADDRESS,
        IllegalDataValue = MXIO_CS.ILLEGAL_DATA_VALUE,
        SlaveDeviceFailure = MXIO_CS.SLAVE_DEVICE_FAILURE,
        SlaveDeviceBusy = MXIO_CS.SLAVE_DEVICE_BUSY,
        EIOTimeOut = MXIO_CS.EIO_TIME_OUT,
        EIOInitSocketsFail = MXIO_CS.EIO_INIT_SOCKETS_FAIL,
        EIOCreatingSocketError = MXIO_CS.EIO_CREATING_SOCKET_ERROR,
        EIOResponseBad = MXIO_CS.EIO_RESPONSE_BAD,
        EIOSocketDisconnect = MXIO_CS.EIO_SOCKET_DISCONNECT,
        ProtocolTypeError = MXIO_CS.PROTOCOL_TYPE_ERROR,
        SIOOpenFail = MXIO_CS.SIO_OPEN_FAIL,
        SIOTimeOut = MXIO_CS.SIO_TIME_OUT,
        SIOCloseFail = MXIO_CS.SIO_CLOSE_FAIL,
        SIOPurgeCommFail = MXIO_CS.SIO_PURGE_COMM_FAIL,
        SIOFlushFileBuffersFail = MXIO_CS.SIO_FLUSH_FILE_BUFFERS_FAIL,
        SIOGetCommStateFail = MXIO_CS.SIO_GET_COMM_STATE_FAIL,
        SIOSetCommStateFail = MXIO_CS.SIO_SET_COMM_STATE_FAIL,
        SIOSetupCommFail = MXIO_CS.SIO_SETUP_COMM_FAIL,
        SIOSetCommTimeOutFail = MXIO_CS.SIO_SET_COMM_TIME_OUT_FAIL,
        SIOClearCommFail = MXIO_CS.SIO_CLEAR_COMM_FAIL,
        SIOResponseBad = MXIO_CS.SIO_RESPONSE_BAD,
        SIOTransmissionModeError = MXIO_CS.SIO_TRANSMISSION_MODE_ERROR,
        ProductNotSupported = MXIO_CS.PRODUCT_NOT_SUPPORT,
        HandleError = MXIO_CS.HANDLE_ERROR,
        SlotOutOfRange = MXIO_CS.SLOT_OUT_OF_RANGE,
        ChannelOutOfRange = MXIO_CS.CHANNEL_OUT_OF_RANGE,
        CoilTypeError = MXIO_CS.COIL_TYPE_ERROR,
        RegisterTypeError = MXIO_CS.REGISTER_TYPE_ERROR,
        FunctionNotSupport = MXIO_CS.FUNCTION_NOT_SUPPORT,
        OutputValueOutOfRange = MXIO_CS.OUTPUT_VALUE_OUT_OF_RANGE,
        InputValueOutOfRange = MXIO_CS.INPUT_VALUE_OUT_OF_RANGE
    }
