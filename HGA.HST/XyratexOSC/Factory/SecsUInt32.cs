...
namespace XyratexOSC.Factory
{
    ...
    /// </summary>
    [Serializable]
    public sealed class SecsUInt32 : ISecsValue, IComparable<SecsUInt32>
    {
        private readonly UInt32 _value;
        private readonly string _format = "U4";
        private const int _length = 4;

        /// <summary>
        /// Initializes a new instance of the <see cref="SecsUInt32"/> class.
        /// </summary>
        /// <param name="value">The value.</param>
        public SecsUInt32(UInt32 value)
        {
            _value = value;
        }
        ...
        {
            return CompareTo((SecsUInt32)obj);
        }
        ...
        /// <summary>
        /// Determines if the two <see cref="SecsUInt32"/> values are equal.
        /// </summary>
        /// <param name="val1">Value 1</param>
        /// <param name="val2">Value 2</param>
        /// <returns>True, if equal; otherwise, false.</returns>
        public static bool operator ==(SecsUInt32 val1, SecsUInt32 val2)
        {
        ...
        /// <summary>
        /// Determines if the two <see cref="SecsUInt32"/> values are not equal.
        /// </summary>
        /// <param name="val1">Value 1</param>
        /// <param name="val2">Value 2</param>
        ...
        /// <summary>
        /// Determines if <see cref="SecsUInt32"/> value 1 is greater than value 2.
        /// </summary>
        /// <param name="val1">Value 1.</param>
        /// <param name="val2">Value 2.</param>
        ...
        /// <summary>
        /// Determines if <see cref="SecsUInt32"/> value 1 is less than value 2.
        /// </summary>
        /// <param name="val1">Value 1.</param>
        /// <param name="val2">Value 2.</param>
        ...
        /// <summary>
        /// Adds the two <see cref="SecsUInt32"/> values.
        /// </summary>
        /// <param name="lhs">Left-hand side value.</param>
        /// <param name="rhs">Right-hand side value.</param>
        /// <returns></returns>
        public static SecsUInt32 operator +(SecsUInt32 lhs, SecsUInt32 rhs)
        {
            return new SecsUInt32(lhs._value + rhs._value);
        }

        /// <summary>
        /// Subtracts the two <see cref="SecsUInt32"/> values.
        /// </summary>
        /// <param name="lhs">Left-hand side value.</param>
        /// <param name="rhs">Right-hand side value.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Subtracts the specified <see cref="SecsUInt32"/> value.
        /// </summary>
        /// <param name="val">The val.</param>
        /// <returns></returns>
        public static SecsUInt32 operator -(SecsUInt32 val)
        {
            return 0 - val;
        }

        /// <summary>
        /// Implicit conversion from <see cref="System.UInt32"/> to <see cref="SecsUInt32"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public static implicit operator SecsUInt32(UInt32 value)
        {
            return new SecsUInt32(value);
        }

        /// <summary>
        /// Implicit conversion from <see cref="SecsUInt32"/> to <see cref="System.UInt32"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public static implicit operator UInt32(SecsUInt32 value)
        {
            return value._value;
        }
    }
