...
namespace XyratexOSC.Factory
{
    ...
    /// </summary>
    [Serializable]
    public sealed class SecsInt64 : ISecsValue, IComparable<SecsInt64>
    {
        private readonly Int64 _value;
        private readonly string _format = "I8";
        private const int _length = 8;

        /// <summary>
        /// Initializes a new instance of the <see cref="SecsInt64"/> class.
        /// </summary>
        /// <param name="value">The value.</param>
        public SecsInt64(Int64 value)
        {
            _value = value;
        }
        ...
        {
            return CompareTo((SecsInt64)obj);
        }
        ...
        /// <summary>
        /// Determines if the two <see cref="SecsInt64"/> values are equal.
        /// </summary>
        /// <param name="val1">Value 1</param>
        /// <param name="val2">Value 2</param>
        /// <returns>True, if equal; otherwise, false.</returns>
        public static bool operator ==(SecsInt64 val1, SecsInt64 val2)
        {
        ...
        /// <summary>
        /// Determines if the two <see cref="SecsInt64"/> values are not equal.
        /// </summary>
        /// <param name="val1">Value 1</param>
        /// <param name="val2">Value 2</param>
        ...
        /// <summary>
        /// Determines if <see cref="SecsInt64"/> value 1 is greater than value 2.
        /// </summary>
        /// <param name="val1">Value 1.</param>
        /// <param name="val2">Value 2.</param>
        ...
        /// <summary>
        /// Determines if <see cref="SecsInt64"/> value 1 is less than value 2.
        /// </summary>
        /// <param name="val1">Value 1.</param>
        /// <param name="val2">Value 2.</param>
        ...
        /// <summary>
        /// Adds the two <see cref="SecsInt64"/> values.
        /// </summary>
        /// <param name="lhs">Left-hand side value.</param>
        /// <param name="rhs">Right-hand side value.</param>
        /// <returns></returns>
        public static SecsInt64 operator +(SecsInt64 lhs, SecsInt64 rhs)
        {
            return new SecsInt64(lhs._value + rhs._value);
        }

        /// <summary>
        /// Subtracts the two <see cref="SecsInt64"/> values.
        /// </summary>
        /// <param name="lhs">Left-hand side value.</param>
        /// <param name="rhs">Right-hand side value.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Subtracts the specified <see cref="SecsInt64"/> value.
        /// </summary>
        /// <param name="val">The val.</param>
        /// <returns></returns>
        public static SecsInt64 operator -(SecsInt64 val)
        {
            return 0 - val;
        }

        /// <summary>
        /// Implicit conversion from <see cref="System.Int64"/> to <see cref="SecsInt64"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public static implicit operator SecsInt64(Int64 value)
        {
            return new SecsInt64(value);
        }

        /// <summary>
        /// Implicit conversion from <see cref="SecsInt64"/> to <see cref="System.Int64"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public static implicit operator Int64(SecsInt64 value)
        {
            return value._value;
        }
    }
