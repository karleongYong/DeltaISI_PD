...
{	
	...
	public interface IReadOnlyProfile : ICloneable
	{
        ...
        /// <param name="notFound">
        ///   set to true if the value was not found. </param>
		/// <returns>
		...
		/// <seealso cref="HasEntry" />
		string GetValue(string section, string entry, string defaultValue, out bool notFound);
		...
		/// <seealso cref="HasEntry" />
		int GetValue(string section, string entry, int defaultValue, out bool notFound);
		...
		///   given default value should be returned. </returns>
		/// <seealso cref="HasEntry" />
		double GetValue(string section, string entry, double defaultValue, out bool notFound);
		...
		/// <seealso cref="HasEntry" />
		bool GetValue(string section, string entry, bool defaultValue, out bool noValue);
