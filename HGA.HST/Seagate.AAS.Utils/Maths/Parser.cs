...
// 			}
		...
		{
			// Solve Sin, Cos, Tan...
			// with comma separation: Regex regEx = new Regex(@"([a-z]{2,})([\+-]?\d+,*\d*[eE][\+-]*\d+|[\+-]?\d+,*\d*)", RegexOptions.IgnoreCase );
			...
			// with comma separation: regEx = new Regex( @"(\d+,*\d*[eE][\+-]?\d+|\d+,*\d*)!" ); // Search for patterns like 5!
			...
			// Solve power.
			// with comma separation: regEx = new Regex( @"\{(.+)\}\^(-?\d+,*\d*[eE][\+-]?\d+|-?\d+,*\d*)" ); // Search for patterns like {-5}^-1
			...
			// with comma separation: regEx = new Regex( @"(\d+,*\d*e[\+-]?\d+|\d+,*\d*)\^(-?\d+,*\d*[eE][\+-]?\d+|-?\d+,*\d*)" ); // Search for patterns like 5^-1
