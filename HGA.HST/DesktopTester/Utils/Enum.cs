...
namespace DesktopTester.Utils
{
    ...
    public enum MessageID
    {
        ...
        HST_desktop_tester_connect = 80,
        HST_desktop_tester_set_homing_axis = 81,
        HST_desktop_tester_set_servo_off = 82,
        HST_desktop_tester_set_servo_abs_move_axis = 83,
        HST_desktop_tester_set_servo_rel_move_axis = 84,
        HST_desktop_tester_get_servo_positions = 85,
        HST_desktop_tester_teach_servo_position = 86,
        HST_desktop_tester_move_to_taught_servo_position = 87,
        HST_desktop_tester_save_taught_position = 88,
        HST_desktop_tester_set_output = 89,
        HST_desktop_tester_get_all_inputs = 90,
        HST_desktop_tester_load_hga = 91,
        HST_desktop_tester_eject_hga = 92,
        HST_desktop_tester_disconnect = 93,
        HST_desktop_tester_jog = 94,
        HST_desktop_tester_jog_stop = 95,
        HST_desktop_tester_precisor_vac_on = 96,
    ...
    public enum GUIPage
    {
        ...
        DebugTabPage = 8,
        ServoCalibrationTabPage = 9,
        DesktopTestsTabPage = 10
    }
