...
{
    public unsafe struct TestProbe18StartAutoCalibration
    {        
        ...
        public static TestProbe18StartAutoCalibration ReadStruct(byte[] data)
        {
            fixed (byte* pb = &data[0])
            {
                return *(TestProbe18StartAutoCalibration*)pb;
            }
        }
