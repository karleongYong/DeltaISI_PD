...
namespace Seagate.AAS.Parsel.Device.RFID.Hga
{
	...
	/// </summary>
	public partial class FolaTagDataForm : System.Windows.Forms.Form
	{
        // Nested declarations -------------------------------------------------
        
        // Member variables ----------------------------------------------------

        private FolaTagData tag = new FolaTagData();
        private FolaReader _reader;
        private bool _readOnly = true;
        // Constructors & Finalizers -------------------------------------------

        public FolaTagDataForm()
		{
			//
        ...
        public bool ReadOnly
	    {
            ...
            { 
                _readOnly = value; 
                folaTagDataHgaPanel1.ReadOnly = _readOnly;
        ...
        private void btnReadtag_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                folaTagDataHgaPanel1.DisplayTagData(tag);
        ...
        private void btnWritetag_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                folaTagDataHgaPanel1.UpdateTag(tag);
                _reader.WriteRFIDTag(RFHead.Head1, tag, chkCarrierID.Checked);
