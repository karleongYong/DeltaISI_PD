...
{
    public unsafe struct TestProbe13GetAllHGABiasVoltages
    {        
        ...
        public static TestProbe13GetAllHGABiasVoltages ReadStruct(byte[] data)
        {
            fixed (byte* pb = &data[0])
            {
                return *(TestProbe13GetAllHGABiasVoltages*)pb;
            }
        }
