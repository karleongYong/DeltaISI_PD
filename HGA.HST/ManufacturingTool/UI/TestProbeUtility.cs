        ...
        private void testProbeComPort_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            ...
            switch (CommandID)
            {
                ...
                case (byte)MessageID.HST_start_meas: // 9
                    UpdateGUIDisplay(GUIPage.ManufacturingTestTabPage, CommandID, readDataBuffer);
                    break;
                ...
                switch (page)
                {
                    ...
                    case GUIPage.BenchTestsTabPage:
                        ...
                        if (CommandID == (byte)MessageID.HST_get_res_results)
                        {
                            ...
                            if (double.Parse(txtBenchTestsHGA1Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA1Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA1Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA1Ch1Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA1Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA1Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA1Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA1Ch2Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA1Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA1Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA1Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA1Ch3Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA1Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA1Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA1Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA1Ch4Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA1Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA1Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA1Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA1Ch5Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA1Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA1Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA1Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA1Ch6Res.BackColor = Color.Empty; }
                            // HGA2
                            ...
                            if (double.Parse(txtBenchTestsHGA2Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA2Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA2Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA2Ch1Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA2Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA2Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA2Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA2Ch2Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA2Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA2Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA2Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA2Ch3Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA2Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA2Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA2Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA2Ch4Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA2Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA2Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA2Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA2Ch5Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA2Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA2Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA2Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA2Ch6Res.BackColor = Color.Empty; }
                            // HGA3
                            ...
                            if (double.Parse(txtBenchTestsHGA3Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA3Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA3Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else
                            {
                                txtBenchTestsHGA3Ch1Res.BackColor = Color.Empty;
                            }
                            if (double.Parse(txtBenchTestsHGA3Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA3Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA3Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else
                            {
                                txtBenchTestsHGA3Ch2Res.BackColor = Color.Empty;
                            }
                            if (double.Parse(txtBenchTestsHGA3Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA3Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA3Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else
                            {
                                txtBenchTestsHGA3Ch3Res.BackColor = Color.Empty;
                            }
                            if (double.Parse(txtBenchTestsHGA3Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA3Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA3Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else
                            {
                                txtBenchTestsHGA3Ch4Res.BackColor = Color.Empty;
                            }
                            if (double.Parse(txtBenchTestsHGA3Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA3Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA3Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else
                            {
                                txtBenchTestsHGA3Ch5Res.BackColor = Color.Empty;
                            }
                            if (double.Parse(txtBenchTestsHGA3Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA3Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA3Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else
                            {
                                txtBenchTestsHGA3Ch6Res.BackColor = Color.Empty;
                            }
                            // HGA4
                            ...
                            if (double.Parse(txtBenchTestsHGA4Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA4Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA4Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA4Ch1Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA4Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA4Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA4Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA4Ch2Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA4Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA4Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA4Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA4Ch3Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA4Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA4Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA4Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA4Ch4Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA4Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA4Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA4Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA4Ch5Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA4Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA4Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA4Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA4Ch6Res.BackColor = Color.Empty; }
                            // HGA5
                            ...
                            if (double.Parse(txtBenchTestsHGA5Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA5Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA5Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA5Ch1Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA5Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA5Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA5Ch2Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA5Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA5Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA5Ch3Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA5Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA5Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA5Ch4Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA5Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA5Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA5Ch5Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA5Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA5Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA5Ch6Res.BackColor = Color.Empty; }
                            // HGA6
                            ...
                            if (double.Parse(txtBenchTestsHGA6Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA6Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA6Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA6Ch1Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA6Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA6Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA6Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA6Ch2Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA6Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA6Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA6Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA6Ch3Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA6Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA6Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA6Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA6Ch4Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA6Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA6Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA6Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA6Ch5Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA6Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA6Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA6Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA6Ch6Res.BackColor = Color.Empty; }
                            // HGA7
                            ...
                            if (double.Parse(txtBenchTestsHGA7Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA7Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA7Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA7Ch1Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA7Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA7Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA7Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA7Ch2Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA7Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA7Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA7Ch3Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA7Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA7Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA7Ch4Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA7Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA7Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA7Ch5Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA7Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA7Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA7Ch6Res.BackColor = Color.Empty; }
                            // HGA8
                            ...
                            if (double.Parse(txtBenchTestsHGA8Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA8Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA8Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA8Ch1Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA8Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA8Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA8Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA8Ch2Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA8Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA8Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA8Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA8Ch3Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA8Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA8Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA8Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA8Ch4Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA8Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA8Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA8Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA8Ch5Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA8Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA8Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA8Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA8Ch6Res.BackColor = Color.Empty; }
                            // HGA9
                            ...
                            if (double.Parse(txtBenchTestsHGA9Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA9Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA9Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA9Ch1Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA5Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA9Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA9Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA9Ch2Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA9Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA9Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA9Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA9Ch3Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA9Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA9Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA9Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA9Ch4Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA9Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA9Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA9Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA9Ch5Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA9Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA9Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA9Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA9Ch6Res.BackColor = Color.Empty; }
                            // HGA10
                            ...
                            if (double.Parse(txtBenchTestsHGA10Ch1Res.Text, CultureInfo.InvariantCulture) < 9.8 || double.Parse(txtBenchTestsHGA10Ch1Res.Text, CultureInfo.InvariantCulture) > 10.2)
                            {
                                txtBenchTestsHGA10Ch1Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA10Ch1Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA10Ch2Res.Text, CultureInfo.InvariantCulture) < 98 || Double.Parse(txtBenchTestsHGA10Ch2Res.Text, CultureInfo.InvariantCulture) > 102)
                            {
                                txtBenchTestsHGA10Ch2Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA10Ch2Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA10Ch3Res.Text, CultureInfo.InvariantCulture) < 54.88 || Double.Parse(txtBenchTestsHGA10Ch3Res.Text, CultureInfo.InvariantCulture) > 57.12)
                            {
                                txtBenchTestsHGA10Ch3Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA10Ch3Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA10Ch4Res.Text, CultureInfo.InvariantCulture) < 60.76 || Double.Parse(txtBenchTestsHGA10Ch4Res.Text, CultureInfo.InvariantCulture) > 63.24)
                            {
                                txtBenchTestsHGA10Ch4Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA10Ch4Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA10Ch5Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA10Ch5Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA10Ch5Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA10Ch5Res.BackColor = Color.Empty; }
                            if (double.Parse(txtBenchTestsHGA10Ch6Res.Text, CultureInfo.InvariantCulture) < 499.8 || Double.Parse(txtBenchTestsHGA10Ch6Res.Text, CultureInfo.InvariantCulture) > 520.2)
                            {
                                txtBenchTestsHGA10Ch6Res.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA10Ch6Res.BackColor = Color.Empty; }
                        }
                        ...
                        if (CommandID == (byte)MessageID.HST_get_cap_results)
                        {
                            ...
                            if (double.Parse(txtBenchTestsHGA1Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA1Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA1Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA1Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA1Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA1Ch2Capa.Text, CultureInfo.InvariantCulture) >150)
                            {
                                txtBenchTestsHGA1Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA1Ch2Capa.BackColor = Color.Empty; }
                            ...
                            if (double.Parse(txtBenchTestsHGA2Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA2Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA2Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA2Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA2Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA2Ch2Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA2Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA2Ch2Capa.BackColor = Color.Empty; }
                            ...
                            if (double.Parse(txtBenchTestsHGA3Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA3Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA3Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA3Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA3Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA3Ch2Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA3Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA3Ch2Capa.BackColor = Color.Empty; }
                            ...
                            if (double.Parse(txtBenchTestsHGA4Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA4Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA4Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA4Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA4Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA4Ch2Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA4Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA4Ch2Capa.BackColor = Color.Empty; }
                            ...
                            if (double.Parse(txtBenchTestsHGA5Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA5Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA5Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA5Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA5Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA5Ch2Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA5Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA5Ch2Capa.BackColor = Color.Empty; }
                            ...
                            if (double.Parse(txtBenchTestsHGA6Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA6Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA6Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA6Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA6Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA6Ch2Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA6Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA6Ch2Capa.BackColor = Color.Empty; }
                            ...
                            if (double.Parse(txtBenchTestsHGA7Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA7Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA7Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA7Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA7Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA7Ch2Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA7Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA7Ch2Capa.BackColor = Color.Empty; }
                            ...
                            if (double.Parse(txtBenchTestsHGA8Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA8Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA8Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA8Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA8Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA8Ch2Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA8Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA8Ch2Capa.BackColor = Color.Empty; }
                            ...
                            if (double.Parse(txtBenchTestsHGA9Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA9Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA9Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA9Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA9Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA9Ch2Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA9Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA9Ch2Capa.BackColor = Color.Empty; }
                            ...
                            if (double.Parse(txtBenchTestsHGA10Ch1Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA10Ch1Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA10Ch1Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA10Ch1Capa.BackColor = Color.Empty; }

                            if (double.Parse(txtBenchTestsHGA10Ch2Capa.Text, CultureInfo.InvariantCulture) < 80 || Double.Parse(txtBenchTestsHGA10Ch2Capa.Text, CultureInfo.InvariantCulture) > 150)
                            {
                                txtBenchTestsHGA10Ch2Capa.BackColor = Color.Red;
                                PCBAFunctionalTestStatusFlag = false;
                            }
                            else { txtBenchTestsHGA10Ch2Capa.BackColor = Color.Empty; }
                        }
                    ...
                    case GUIPage.PCBACalibrationTabPage:
                        ...
                        if (CommandID == (byte)MessageID.HST_set_temp_calibration)
                        {
                            ...
                            Log.Info("Prompt", "6.) PCBA Temperature Calibration Test - Voltage (uV) : {0}\n", TestProbe31GetTemperatureCalibration.Voltage());
                        }
                    ...
                    case GUIPage.ManufacturingTestTabPage:
                        if (CommandID == (byte)MessageID.HST_get_firmware_version)
                        {
                            PCBACommunicationStatusFlag = true;
                        }
                        else if (CommandID == (byte)MessageID.HST_config_temp_meas)
                        {
                            PCBAParameterSettingsStatusFlag = true;
                        }
                        else if (CommandID == (byte)MessageID.HST_save_calibration_data)
                        {
                            PCBAAutoCalibrationStatusFlag = true;
                        }
                        else if (CommandID == (byte)MessageID.HST_set_short_detection_threshold)
                        {
                            PCBAShortCircuitSettingsStatusFlag = true;
                        }
                        else if (CommandID == (byte)MessageID.HST_set_precisor_cap_compensation)
                        {
                            PCBADisablePrecisorCompensationStatusFlag = true;
                        }
                        else if (CommandID == (byte)MessageID.HST_set_precisor_cap_compensation)
                        {
                            PCBADisablePrecisorCompensationStatusFlag = true;
                        }
                        else if (CommandID == (byte)MessageID.HST_set_temp_calibration)
                        {
                            PCBATemperatureCalibrationStatusFlag = true;
                        }
                      //  else if (CommandID == (byte)MessageID.HST_start_meas)
                      //  {
